...
export default function GrowthSystemsPage() {
  return (
    <div className="relative bg-[#020617] text-white min-h-screen px-4 sm:px-8 md:px-16 pt-28 overflow-hidden">
      ...
      {/* CASE STUDY */}
      <section className="max-w-5xl mx-auto mt-24 text-gray-300 space-y-8 relative z-10">
        ...
        <div className="space-y-6">
          <p>
            A growth-stage organization in a competitive digital market faced
            operational bottlenecks, inconsistent revenue performance, and
            fragmented infrastructure despite strong demand.
          </p>

          <div className="grid md:grid-cols-2 gap-8">
            <div>
              <h3 className="text-purple-300 font-semibold mb-2">The Challenge</h3>
              <ul className="space-y-2 text-red-300 text-sm">
                <li>• Disconnected systems</li>
                <li>• Unpredictable lead generation</li>
                <li>• Lack of data visibility</li>
                <li>• Operational inefficiencies</li>
                <li>• Non-scalable tech infrastructure</li>
              </ul>
            </div>

            <div>
              <h3 className="text-purple-300 font-semibold mb-2">The Outcome</h3>
              <ul className="space-y-2 text-green-300 text-sm">
                <li>• 2.5× increase in qualified leads</li>
                <li>• 35% higher conversion rates</li>
                <li>• 40% operational efficiency gain</li>
          ...
          <div className="p-6 rounded-2xl bg-white/5 border border-white/10 text-purple-200">
            By implementing a structured transformation model—diagnosing,
            architecting, deploying, and optimizing systems—the organization
            transitioned from fragmented execution to a scalable, system-driven
            growth engine.
          </div>
        </div>
      </section>
