...
export default function CaseStudy3() {
  const data = {
    title: "Transforming a SaaS Platform into Scalable Infrastructure",
    subtitle: "Case Study 3",

    clientContext:
      "A SaaS startup experiencing rapid user growth faced increasing performance issues and scalability limitations.",
    ...
    approachIntro:
      "Brainixt restructured the platform from product-level architecture to scalable infrastructure.",

    approach: [
      {
        title: "Diagnose",
        desc: "Evaluated system architecture, performance bottlenecks, and scalability gaps.",
      },
      {
        title: "Architect",
        desc: `Designed a platform-based architecture including:
...
• Scalable data infrastructure`,
      ...
      {
        title: "Deploy",
        desc: "Rebuilt critical systems and integrated scalable architecture.",
      },
      {
        title: "Drive Performance",
        desc: "Optimized system performance, reliability, and scalability.",
      },
    ],

    impact: [
      "3× improvement in system performance",
      "Enhanced scalability for future growth",
      "Improved integration capabilities",
      "Reduced technical debt",
    ],

    insight: `SaaS growth is not limited by product features.
It is limited by infrastructure design.`,
  };
