  ...
  return (
    <div className="bg-[#020617] text-white min-h-screen pt-28 px-4 sm:px-8 md:px-16 pb-20">
      ...
      <div className="fixed right-4 top-1/2 -translate-y-1/2 z-50 flex flex-col gap-3 text-gray-400">
        ...
        <a href="https://www.linkedin.com/company/brainixt/?viewAsMember=true" target="_blank" rel="noopener noreferrer" className="p-2 rounded-full bg-white/5 border border-white/10 hover:bg-white/10 transition group">
          <FaLinkedin size={20} className="transition group-hover:text-[#0A66C2] group-hover:scale-110"/>
        </a>

        <a href="https://www.instagram.com/brainixt/" target="_blank" rel="noopener noreferrer" className="p-2 rounded-full bg-white/5 border border-white/10 hover:bg-white/10 transition group">
          <FaInstagram size={20} className="transition group-hover:text-[#E1306C] group-hover:scale-110"/>
        </a>

        <a href="https://x.com/brainixt" target="_blank" rel="noopener noreferrer" className="p-2 rounded-full bg-white/5 border border-white/10 hover:bg-white/10 transition group">
          <FaXTwitter size={20} className="transition group-hover:text-gray-300 group-hover:scale-110"/>
        </a>

        <a href="https://www.youtube.com/channel/UCS9yTV69guZ5Mau9Fki8fBQ" target="_blank" rel="noopener noreferrer" className="p-2 rounded-full bg-white/5 border border-white/10 hover:bg-white/10 transition group">
          <FaYoutube size={20} className="transition group-hover:text-red-500 group-hover:scale-110"/>
        </a>

        <a href="https://www.facebook.com/brainixt" target="_blank" rel="noopener noreferrer" className="p-2 rounded-full bg-white/5 border border-white/10 hover:bg-white/10 transition group">
          <FaFacebook size={20} className="transition group-hover:text-blue-500 group-hover:scale-110"/>
        </a>
      ...
      <section className="max-w-4xl mx-auto mb-16">
        ...
        <form ref={formRef} onSubmit={handleSubmit} className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <input name="full_name" placeholder="Full Name" className="p-3 rounded bg-white/5 border border-white/10 text-sm" required />
          <input name="company_name" placeholder="Company Name" className="p-3 rounded bg-white/5 border border-white/10 text-sm" />

          <input name="email" placeholder="Email Address" className="p-3 rounded bg-white/5 border border-white/10 text-sm" required />
          <input name="phone" placeholder="Phone Number" className="p-3 rounded bg-white/5 border border-white/10 text-sm" />

          <input name="industry" placeholder="Industry" className="p-3 rounded bg-white/5 border border-white/10 text-sm" />
          <input name="organization_size" placeholder="Organization Size" className="p-3 rounded bg-white/5 border border-white/10 text-sm" />
          ...
          <button type="submit" className="sm:col-span-2 mt-2 px-6 py-3 rounded-full bg-gradient-to-r from-indigo-400 to-purple-500 text-black font-medium hover:scale-105 transition">
            Submit Inquiry
          </button>
        </form>
      </section>
      ...
      <section className="text-center mb-16">
        ...
        <a href="https://www.linkedin.com/in/parthjainync/">
