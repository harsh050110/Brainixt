...
export default function FintechPage() {
  const data = {
    ...
    subtitle: "Aligning Technology and Compliance for Scalable Finance",

    description:
      "Financial institutions and fintech startups operate within highly regulated and technology-driven environments. Scalability, security, and operational transparency are critical requirements.",

    details:
      "Brainixt partners with financial organizations to build digital infrastructure that supports innovation while maintaining operational discipline.",

    capabilities: [
      {
        title: "Digital Onboarding Systems",
        desc: "Streamlined onboarding with compliance and identity verification.",
      },
      {
        title: "Customer Lifecycle Systems",
        desc: "Manage engagement, retention, and financial journeys.",
      },
      {
        title: "Platform Infrastructure",
        desc: "Secure, scalable financial systems and integrations.",
      },
      {
        title: "Analytics & Reporting",
        desc: "Real-time dashboards for operational and financial insights.",
      },
      {
        title: "Growth & Expansion",
        desc: "Strategic scaling while maintaining compliance and control.",
      },
    ],
    ...
    metrics: [
      ...
      { value: "100%", label: "Compliance Alignment" },
      { value: "2x", label: "Operational Efficiency" },
    ],

    closing:
      "These systems help financial organizations scale while maintaining operational resilience and regulatory alignment.",
  };
    ...
    <div className="bg-[#020617] text-white min-h-screen pt-28 px-4 sm:px-8 md:px-16 pb-16">
      ...
      <div className="max-w-5xl mx-auto mb-20">
        ...
        <div className="flex flex-col md:flex-row items-center gap-4 text-center">
          {data.complianceFlow.map((step, i) => (
            <div key={i} className="w-full md:flex-1 flex flex-col items-center">
              ...
              {i !== data.complianceFlow.length - 1 && (
